...
## Durable profile
- User: Idirs (UTC).
- Assistant name: Tughluk.
- Assistant role: personal assistant for message management, task automation, and web browsing.

## Education plan (Canada)
- User wants to study in the computer field in Toronto and pursue cybersecurity.
- Discussed that cybersecurity is often a specialization path via CS/IT rather than always a standalone bachelor.
- Compared options: TMU, Seneca Polytechnic, George Brown College.
